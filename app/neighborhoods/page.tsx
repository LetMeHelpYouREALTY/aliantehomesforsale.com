    ...
    <>
      ...
      <main className="neighborhoods-page">
        ...
        <NeighborhoodComparison
          ...
          subheading="Club Aliante, Prominence, Desert Willows, The Paseos, and Sun City Aliante 55+. Nearby Tule Springs is east of 89084 — not in this table. Confirm live MLS prices."
        />
