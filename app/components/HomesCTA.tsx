...
export default function HomesCTA({
  ...
  subheading = 'Confirm live MLS for Club Aliante, gated villages, and Sun City Aliante. Call (702) 707-7273.',
  secondaryHref = '/market-report',
  secondaryLabel = 'Get Market Report',
  calendlyEvent = 'showing',
  calendlyLabel = 'Schedule a private showing',
}: HomesCTAProps) {
  return (
    <section
